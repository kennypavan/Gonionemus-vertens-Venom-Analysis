...
toxin_file = pd.read_csv("Data/All/BLASTx_ToxinProt/diamond-toxin-out-with-tpm.txt",sep='\t', header=None)
...
plt.savefig('Data/All/BLASTx_ToxinProt/length-tpm-scatter.png')

toxin_tpm_1.plot.scatter(x="pident", y="TPM", alpha=0.5)

plt.savefig('Data/All/BLASTx_ToxinProt/pident-tpm-scatter.png')

toxin_tpm_1.plot.scatter(x="pident", y="length", alpha=0.5)

plt.savefig('Data/All/BLASTx_ToxinProt/pident-length-scatter.png')
